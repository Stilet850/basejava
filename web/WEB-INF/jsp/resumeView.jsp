...
<%@ page import="ru.javawebinar.basejava.model.content.TextSection" %>
    ...
    <table cellpadding="2">
        <c:forEach var="sectionEntry" items="${resume.sections}">
            <jsp:useBean id="sectionEntry"
                         type="java.util.Map.Entry<ru.javawebinar.basejava.model.SectionType, ru.javawebinar.basejava.model.content.Section>"/>
