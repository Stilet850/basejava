...
//    private static final String UUID_NEW = "uuid_new";
    ...
    public static Resume R1 = create(UUID1, "abcd");
    private static Resume R2 = create(UUID2, "bbd");
    private static Resume R3 = create(UUID3, "ccd");
    static Resume R_NEW = create(UUID_NEW, "ddddd");
...
//    }
    ...
    public void update() {
        ...
        resume.setContact(ContactType.EMAIL, "mail@mail.ru");
        resume.setContact(ContactType.SKYPE, "newSkype");
        resume.setContact(ContactType.LANDLINE, "+375 29 5465465456");
